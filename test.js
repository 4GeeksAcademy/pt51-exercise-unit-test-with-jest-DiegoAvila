...
test("One euro should be 156.5 yenes", function() {
    ...
    // Hago mi comparación (la prueba)
    expect(fromDollarToYen(3.5)).toBe("511.92"); // 1 euro son 156.5 yenes, entonces 3.5 euros deberían ser = (3.5 * 156.5) dividido entre el valor del dollar en euro 1.07
})
test("One euro should be 0.87 pound", function() {
    ...
    // Hago mi comparación (la prueba)
    expect(fromYenToPound(3.5)).toBe("0.02"); // 1 euro son 156.5 yenes, entonces 3.5 euros deberían ser = (3.5 * 156.5) dividido entre el valor del dollar en euro 1.07
})